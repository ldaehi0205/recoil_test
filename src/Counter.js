...
function Counter() {
  ...
  const countStateSelect = useRecoilValueLoadable(countStateSelector);
  ...
  console.log("useRecoilValue", currentInput);
  console.log("useRecoilValueLoadable", countStateSelect);
  console.log("render");
  return (
    <div>
      <div>
